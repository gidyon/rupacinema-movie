...
import (
	...
	grpc_server "github.com/gidyon/rupacinema/movie/internal/protocol/grpc"
...
func createRESTMux(
	...
	err = movie.RegisterMovieAPIHandlerFromEndpoint(
		ctx,
		gwmux,
		cfg.GRPCPort,
		dopts,
...
func serve(
	...
	logger.Log.Info(
		"<gRPC and REST> server for movie service running",
	...
	go func() {
		for range c {
			logger.Log.Warn("shutting movie service....")
			srv.Shutdown(ctx)
